...
ROL_BOLIMLARI = {
    "yordamchi": ["cheklar", "tovarqidir", "inv", "kirim"],
    "onec": [],
}
...
async def hisobot_top(
    ...
    # Маҳсулот/гуруҳ/сотувчи/мижоз кесимлари — фақат бошқарув учун.
    # Ёрдамчи бу бўлимларни менюда кўрмайди, серверда ҳам тақиқланади.
    admin_kerak(kim)
